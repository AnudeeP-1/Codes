...
glutCreateWindow("Simple shaded scene consisting of a teapot:Anusha : 4sn17cs006");
glutDisplayFunc(displaySolid);
glEnable(GL_LIGHTING);
glEnable(GL_LIGHT0);
glShadeModel(GL_SMOOTH);//Specifies a symbolic value representing a shading technique. Accepted
//values are GL_FLAT and GL_SMOOTH.
