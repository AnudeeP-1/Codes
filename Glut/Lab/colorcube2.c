...
#include<stdlib.h>
#include<GL/glut.h>
GLfloat v[8][3]={{-100,-100,100},{100,-100,100},{100,100,100},{-100,100,100},{-100,-
...
glLoadIdentity();
//glOrtho(-500,500,-500,500,100,500);
glFrustum(-200,200,-200,200,300,800);
...
drawcube(v[3],v[7],v[4],v[0]);glFlush();
}
...
glutCreateWindow("Perspective View:4SN17CS005: Anudeep G.P");
