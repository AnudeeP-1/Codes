...
{	int m;
    switch ( key )    {
	 ...
	 case 'S':
		 ...
		 tCount++;
		 switch(tCount) {
		 case 1: display_string(580,360,"I am the fastest animal in the whole wide world.",2);
		 break;
		 case 2: display_string(80,330,"All Lies!!!",2);
				 ...
				 display_string(80,290,"end.",2);
				  break;
		 case 3: display_string(580,280,"I will prove to you all that I’m the fastest animal",2);
				 display_string(580,260,"in the whole World.",2);
				  break;
		 case 4: display_string(80,240,"OK! I'll race you then...",2);
		  break;
		 case 5: display_string(580,210,"* Laughs Heavily *",2);
		 break;
		 case 6: display_string(80,180,"You just Wait and See...",2);
		  break;
		 case 7: display_string(300,90,"PRESS SPACE BAR TO PROCEED TO THE RACE",2);
		  break;
		 }
		 glFlush(); }break;
	 case 'o':
	 case 'O':
				...
				glFlush();
				delay(1);
				display_string(300,200,"(The rabbit was over confident",2);
...
void rabbit2() {
	...
	glColor3f(1.0,1.0,1.0);
	glBegin(GL_POLYGON);
	glVertex2i(50 + ssrabbitx,210+40 + ssrabbity);
	glVertex2i(60 + ssrabbitx,210+40 + ssrabbity);
	glVertex2i(70 + ssrabbitx,220+40 + ssrabbity);
	glVertex2i(70 + ssrabbitx,230+40 + ssrabbity);
	glVertex2i(60 + ssrabbitx,240+40 + ssrabbity);
	glVertex2i(50 + ssrabbitx,240+40 + ssrabbity);
	glVertex2i(40 + ssrabbitx,230+40 + ssrabbity);
	glVertex2i(40 + ssrabbitx,220+40 + ssrabbity);
	glEnd();

	//Rabbit Face
	glBegin(GL_LINES);
	for(t=0;t<=360;t++) {
		x=(78 + ssrabbitx)+9*cos(t);
		y=(273 + ssrabbity)+9*sin(t);
		glVertex2f(70 + ssrabbitx,260 + ssrabbity);
		glVertex2f(x,y);
	}
	glEnd();
	...
	glPointSize(4);
	glBegin(GL_POINTS);
	glVertex2i(78 + ssrabbitx,273 + ssrabbity);
	glEnd();
	...
	glBegin(GL_LINES);
	for(t=0;t<=360;t++) {
		x=(74 + ssrabbitx)+4*cos(t);
		y=(295 + ssrabbity)+4*sin(t);
		glVertex2f(70 + ssrabbitx,270 + ssrabbity);
		glVertex2f(x,y);
	}
	glEnd();
}
...
void display1() {
	...
	display_string(350,450,"Srinivas Institute of Technology",1);
	display_string(300,400,"COMPUTER GRAPHICS MINI PROJECT",1);
	display_string(390,360,"Rabbit and Tortoise",2);
	display_string(420,320,"Anudeep G.P.: 4SN17CS005",3);
	display_string(420,300,"Hrithik: 4SN17CS031",3);
