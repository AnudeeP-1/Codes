...
void display1() {
	...
	display_string(250,400,"SRINIVAS INSTITUTE OF TECHNOLOGY,VALACHIL ",1);
	display_string(290,360,"DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING",1);
	display_string(300,300,"COMPUTER GRAPHICS MINI PROJECT ON",1);
	display_string(390,250,"TORTOISE AND RABBIT",1);
	display_string(460,225,"BY",3);
	display_string(350,200,"Anudeep G.P.           4SN17CS005",1);
	display_string(350,170,"Hrithik Alva                4SN17CS031",1);
	...
	display_string(400,100,"PRESS SPACE BAR TO ENTER",3);
	display_string(400,20,"ESCAPE TO EXIT",3);
	display_string(400,50,"F TO FULLSCREEN",3);
	display_string(400,75,"S TO MAKE THEM CONVERSE",3); // Press S to make them converse in the second screen.
...
int main(int argc,char** argv) {
	...
	glutCreateWindow("Tortoise and Rabbit");
